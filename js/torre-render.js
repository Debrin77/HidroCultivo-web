/**
 * Torre vertical / NFT / DWC: render SVG, lista, interacción, tutoriales de cesta.
 * Requiere el bloque previo (state, goTab, MODOS_CULTIVO, …). `tipoInstalacionNormalizado` se define en el setup (script siguiente).
 */
